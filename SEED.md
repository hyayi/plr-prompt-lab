...
- Source `core/ir HEAD`: `d65ee2ebaffb49df3e3f8d091ff0269e03f4e0d3`
  (re-synced 2026-07-02(2): declarative vocabulary schema/vocab.yaml + preprocess.py; earlier syncs `c2fc1cf` → `1690f25` → `92d2665`)
